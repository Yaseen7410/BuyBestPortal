...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/platform-browser'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('@angular/platform-server/init', ['@angular/platform-browser', '@angular/common'], factory) :
    (global = global || self, factory(global.ng.platformBrowser, global.ng.common));
}(this, (function (platformBrowser, common) { 'use strict';
...
//# sourceMappingURL=platform-server-init.umd.js.map
